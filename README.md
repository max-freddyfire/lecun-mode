...
intelligence. Not useless — he's clear they're great tools — but architecturally
incapable of *anticipating the consequences of their own actions*. His prescription is a different architecture: **world models** and
**objective-driven AI**, where the system predicts outcomes, plans by search
toward a goal, and is bound by safety constraints it *cannot violate by
construction*.

LeCun-mode is a small experiment that takes him seriously and, knowingly, the
wrong way. It implements his prescription as a **prompt-layer discipline** — a
skill the model loads and follows — instead of a new architecture.
...
| Data efficiency: learn fast from few examples | One correction → permanent memory of the user's context | 🟡 learns *context* efficiently, not physics |
